...
(function (global, factory) {
    ...
    **/
    ...
    function (_super) {
      ...
      ImageLoader.createElement = function (image) {
      ...
      ImageLoader.isMaybeLoaded = function (image) {
        var result = false;
      ...
      __proto.get = function () {
        ...
        return new Promise(function (res, rej) {
          if (!_this._image) {
            ...
            if (ImageLoader.isMaybeLoaded(_this._image)) {
              _this._loadStatus = STATUS.LOADED;
              res(_this.getElement());
            } else {
              _this.on(EVENT.READYSTATECHANGE, function (e) {
      ...
      __proto.set = function (image) {
        ...
        this.onceLoaded(this._image, function () {
          ...
          _this.trigger(EVENT.READYSTATECHANGE, {
            type: STATUS.LOADED
          });
        }, function () {
          _this._loadStatus = STATUS.ERROR;
      ...
      __proto.onceLoaded = function (target, onload, onerror) {
        var _this = this;
        ...
        var loadPromises = targetsNotLoaded.map(function (img) {
          return new Promise(function (res, rej) {
            _this._once(img, "load", function () {
              return res(img);
            });

            _this._once(img, "error", function () {
              return rej(img);
            });
          });
        });
        Promise.all(loadPromises).then(function (result) {
      ...
      __proto.destroy = function () {
        ...
        this._image.forEach(function (img) {
          return img.src = "";
        });
      ...
      __proto._once = function (target, type, listener) {
    ...
    var _a; // import Agent from "@egjs/agent";
    ...
    var READYSTATECHANGE_EVENT_NAME = (_a = {}, _a[READY_STATUS.HAVE_METADATA] = "loadedmetadata", _a[READY_STATUS.HAVE_CURRENT_DATA] = "loadeddata", _a[READY_STATUS.HAVE_FUTURE_DATA] = "canplay", _a[READY_STATUS.HAVE_ENOUGH_DATA] = "canplaythrough", _a);
    ...
    function () {
      ...
      __proto.get = function () {
        ...
        return new Promise(function (res, rej) {
          ...
          } else if (_this._loadStatus === READY_STATUS.LOADING_FAILED) {
            rej("VideoLoader: video source is invalid");
          } else if (_this._video.readyState >= _this._thresholdReadyState) {
            res(_this._video);
          } else {
            // check errorCnt and reject
            var rejector_1 = function () {
              if (_this._loadStatus === READY_STATUS.LOADING_FAILED) {
                _this._detachErrorHandler(rejector_1);

                rej("VideoLoader: video source is invalid");
              }
            };

            _this._attachErrorHandler(rejector_1);

            _this._once(_this._thresholdEventName, function () {
              return res(_this._video);
            });
          }
        });
      };
      ...
      __proto._appendSourceElement = function (videoUrl) {
        var videoSrc;
        var videoType;
      ...
      __proto._attachErrorHandler = function (handler) {
      ...
      __proto._detachErrorHandler = function (handler) {
      ...
      __proto._reset = function () {
        ...
        this._handlers.forEach(function (handler) {
          _this._video.removeEventListener(handler.type, handler.fn);
        });
      ...
      __proto._once = function (type, listener) {
    ...
    function (_super) {
      ...
      __proto.bindTexture = function () {
        ...
        return new Promise(function (res, rej) {
          if (!_this._contentLoader) {
            rej("ImageLoader is not initialized");
            return;
          }

          _this._contentLoader.get().then(function () {
            _this._bindTexture();
          }, rej).then(res);
        });
      ...
      __proto._onContentLoad = function () {
